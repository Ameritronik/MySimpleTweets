...
* [x] User can **see a counter with total number of characters left for tweet** on compose tweet page
	(Borrowed a character counter from @author Simon Lightfoot <simon@demondevelopers.com> Thank you Simon!
...
* [ ] List anything else that you can get done to improve the app functionality!
	Need to find more time to implement all options and stretch. 

## Video Walkthrough

Here's a walkthrough of implemented user stories:

http://i.imgur.com/71TDTGL.gif

<a href="http://imgur.com/71TDTGL"><img src="http://i.imgur.com/71TDTGL.gif" title="source: imgur.com" /></a>
